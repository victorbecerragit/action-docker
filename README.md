...
- [Latest Kubernetes Vulnerabilities](https://feedly.com/cve/vendors/kubernetes) — CVE-2023-3676A security issue was discovered in Kubernetes where a user that can create pods on Windows nodes may be able to escalate to admin privileges on ...
